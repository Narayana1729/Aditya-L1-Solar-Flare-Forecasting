      ...
      >
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-4">
            <a href="https://pradan.issdc.gov.in/" target="_blank" rel="noopener noreferrer" className={`transition-all duration-500 ${isScrolled ? "text-xs text-foreground/70 hover:text-foreground" : "text-sm text-white/70 hover:text-white"}`}>
              ISRO Portal
            </a>
            <Button
              asChild
            ...
            <button
              ...
              className={`p-1.5 rounded-full border transition-all duration-500 flex items-center justify-center cursor-pointer ${
                isScrolled
                  ? "border-foreground/20 text-foreground hover:bg-foreground/5 hover:border-foreground"
      ...
      >
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          >
            ...
            >
              <a href="https://pradan.issdc.gov.in/" target="_blank" rel="noopener noreferrer" onClick={() => setIsMobileMenuOpen(false)}>
                ISRO Portal
              </a>
            </Button>
            <Button
              asChild
              variant="outline"
              className="flex-1 rounded-full h-14 text-base border-foreground/30"
            >
            ...
            >
              <a href="https://github.com/Narayana1729/Aditya-L1-Solar-Flare-Forecasting" target="_blank" rel="noopener noreferrer" onClick={() => setIsMobileMenuOpen(false)}>
                View on GitHub
              </a>
            </Button>
          </div>
