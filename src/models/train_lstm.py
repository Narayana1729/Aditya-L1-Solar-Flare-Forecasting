...
def prepare_data(input_path, lookback=30, forecast_horizon=30):
    ...
    # 1. Define target using shared utility — single source of truth
...
def train_model():
    ...
    for epoch in range(1, max_epochs + 1):
        ...
        print(f"Epoch {epoch:3d}/{max_epochs} | Train Loss: {train_loss:.4f} | Val Loss: {val_loss:.4f}", end="")
    ...
    print(f"\n[SUCCESS] Model training complete! Best val loss: {best_val_loss:.4f}")
